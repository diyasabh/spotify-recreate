...
const CLIENT_ID = "b75434fd87504aad8e359784f518e15b";
const REDIRECT_URI = "exp://10.31.198.228:19001"; // TODO: Replace this with your own redirect URI
const ALBUM_ID = "1EoDsNmgTLtmwe1BDAVxV5?si=wvlxO3FAS2aNx3FQkxbjQw"; //"64LU4c1nfjz1t4VnGhagcg?si=JyyIWC2ISHKQvb85QByGJg"; // By default, this is the Weeknd's album "DAWN FM"
// ********************************************* //
...
const ENV = {
  ...
  SPOTIFY_API: {
    ...
    ALBUM_TRACK_API_GETTER: (albumId) =>
      `https://api.spotify.com/v1/albums/${albumId}/tracks`, //"https://api.spotify.com/v1/TODO",
  },
};
